...
// json.Marshaler interface. This should return the JSON-encoded value for the watches
// runtime (in our case, it will return a string in the format "<runtime> mins").
func (r Runtime) MarshalJSON() ([]byte, error) {

	// Generate a string containing the watches runtime in the required format.
