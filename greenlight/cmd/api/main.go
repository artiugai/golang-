...
func main() {
	...
	srv := &http.Server{
		...
		Handler: app.routes(),
		// Create a new Go log.Logger instance with the log.New() function, passing in // our custom Logger as the first parameter. The "" and 0 indicate that the
	...
	// But this time we pass a map containing additional properties (the operating environment and server address) as the final parameter.
